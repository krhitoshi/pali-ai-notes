...
【その他】異読は〔異読〕＋写本略号（sī. syā. kaṃ. pī. ka.）で示す。…pe… は（中略）と訳す。
【内容上の注記】本経は不浄観の修習に起因する出来事を叙述する、入出息念（ānāpānassati）導入の因縁譚にあたる。命を絶つ行為への言及は経典本文そのものの記述であり、訳語もそれに即して逐語的に訳出する。
...
* evaṃ = 「このように」
* me = 「私によって」(amha の具格／属格)
* sutaṃ = 「聞かれた」(suṇāti の過去分詞・中性主格)
* ekaṃ samayaṃ = 「あるとき」(時を示す対格)
* bhagavā = 「世尊」
...
* tena kho pana samayena = 「ちょうどそのとき」(時を示す具格)
* bhikkhūnaṃ = 「比丘たちに」(与格・複数)
* anekapariyāyena = 「さまざまな方法で」(具格／持業釈：aneka〔多くの〕+ pariyāya〔方法・教法〕)
* asubhakathaṃ = 「不浄の話を」(対格／依主釈：asubha〔不浄〕+ kathā〔話〕)
* katheti = 「説かれる」(katheti 現在)
* asubhāya = 「不浄の」(属格・与格)
* vaṇṇaṃ = 「称讃を」(対格)
* bhāsati = 「述べられる」
...
* icchāmi ahaṃ = 「私は望む」(icchāmi + ahaṃ → icchāmahaṃ／連声)
* bhikkhave = 「比丘たちよ」(呼格)
...
* na amhi = 「私は～されるべきでない」(na + amhi〔atthi 一人称単数〕)
* kenaci = 「誰によっても」(具格)
* upasaṅkamitabbo = 「近づかれるべき」(upasaṅkamati の未来受動分詞〔義務分詞〕・男性主格、暗黙の ahaṃ と一致)
* aññatra = 「～を除いて」(+具格)
...
* te bhikkhū = 「かの比丘たちは」
* bhagavato = 「世尊に」(与格／属格)
* paṭissutvā = 「応諾して」(paṭissuṇāti の連続体)
* na assu idha = 「実にここでは～しなかった」(na + assu〔強意の不変化辞〕+ idha〔ここで〕→ nāssudha／連声)
* koci = 「誰も（～ない）」
* bhagavantaṃ = 「世尊に」(対格)
...
* te bhikkhū = 「かの比丘たちは」
* （引用句は §3 と同一：「世尊はさまざまな方法で不浄を説き、不浄を称讃し、不浄の修習を称讃される」）
* anekākāravokāraṃ = 「さまざまな様相と仕方で」(副詞的対格／aneka〔多くの〕+ ākāra〔様相〕+ vokāra〔区分・様態〕。註は anekehi ākārehi vokārehi ca と釈す)
* asubhabhāvanānuyogaṃ = 「不浄の修習への専念を」(対格／依主釈：asubhabhāvanā + anuyoga〔専念・実修〕)
...
* te = 「彼らは」
* iminā kāyena = 「この身体によって（＝この身体ゆえに）」(具格)
* aṭṭīyamānā = 「悩み・厭わしく思い」(aṭṭīyati〔悩む・厭う〕の現在分詞・中動・男性複数主格)
  * 〔異読〕aṭṭiyamānā（sī. syā. kaṃ. pī. ka.）
* harāyamānā = 「恥じ・嫌悪し」(harāyati〔恥じる・苦悩する〕の現在分詞)
...
* dasa pi bhikkhū = 「十人もの比丘が」(dasa〔十〕+ pi〔～も〕)
* ekāhena = 「一日に」(具格／eka〔一〕+ aha〔日〕)
* satthaṃ = 「刀を」(対格)
* āharanti = 「用いる（＝刃を当てて命を絶つ）」(āharati 現在。satthaṃ āharati は「刃を用いる／自らに刃を当てる」の慣用表現)
* vīsam pi = 「二十人もが」
...
【出典】Saṃyutta-nikāya, Mahāvagga, Ānāpāna-saṃyutta, 9. Vesālīsutta（承前）
【assāsa/passāsa 方向規約】本箇所に assāsa/passāsa の語は現れない → N/A
【その他】異読は〔異読〕＋写本略号（sī. syā. kaṃ. pī. ka.）で示す。…pe… は（中略）と訳す。

1. Atha kho bhagavā tassa aḍḍhamāsassa accayena paṭisallānā vuṭṭhito āyasmantaṃ ānandaṃ āmantesi –

* atha kho = 「そこで」
* tassa aḍḍhamāsassa accayena = 「その半月が過ぎて」(具格／accaya〔経過〕。「～の経過によって」＝時の経過を示す慣用)
  * aḍḍhamāsa = 「半月」(aḍḍha〔半〕+ māsa〔月〕)
* paṭisallānā = 「独坐より」(奪格／paṭisallāna〔独坐・宴黙〕)
...
* kiṃ nu kho = 「いったいどうして（～なのか）」(疑問の不変化辞)
* ānanda = 「アーナンダよ」(呼格)
* tanubhūto = 「まばらになった、減少した」(tanu〔薄い・少ない〕+ bhūta〔～となった〕／持業釈。過去分詞・男性主格)
* viya = 「～のようである」
...
* tathā hi pana = 「と申しますのも、まさにそのとおり」(理由を導く慣用句)
* bhante = 「尊者よ」(呼格)
* （引用句は前段と同一：「世尊は比丘たちにさまざまな方法で不浄を説き、不浄を称讃し、不浄の修習を称讃される」）
  * bhikkhūnaṃ = 「比丘たちに」(与格・複数)
  * anekapariyāyena = 「さまざまな方法で」(具格)
  * asubhakathaṃ katheti = 「不浄の話を説く」
  * vaṇṇaṃ bhāsati = 「称讃を述べる」
...
* te = 「彼らは」
* iminā kāyena = 「この身体ゆえに」(具格)
* aṭṭīyamānā = 「悩み・厭わしく思い」(aṭṭīyati の現在分詞・男複主格)
* harāyamānā = 「恥じ・嫌悪し」(harāyati の現在分詞)
...
* dasa pi bhikkhū = 「十人もの比丘が」
* ekāhena = 「一日に」(具格／eka + aha〔日〕)
* satthaṃ āharanti = 「刀を用いる（＝刃を当てて命を絶つ）」(satthaṃ āharati は「刃を用いる／自らに刃を当てる」の慣用表現)
...
* sādhu = 「どうか、よろしければ」(懇請の不変化辞)
* bhante = 「尊者よ」(呼格)
* aññaṃ pariyāyaṃ = 「他の方法を」(対格／añña〔他の〕+ pariyāya〔方法・教法〕)
* ācikkhatu = 「お説きください」(ācikkhati の命令・三人称単数)
* yathā ayaṃ = 「この～が～するように」(yathā〔～のように〕+ ayaṃ。連声 yathāyaṃ)
* bhikkhusaṅgho = 「比丘僧伽が」
...
* tena hi ānanda = 「それならば、アーナンダよ」(tena hi〔それでは〕+ ānanda。連声 tenahānanda)
* yāvatikā bhikkhū = 「～する限りのすべての比丘」(yāvatika〔～だけの・～する限りの〕・男複主格)
* vesāliṃ upanissāya = 「ヴェーサーリーに依って（＝近くに）」(upanissāya〔依拠して・近くに〕+ 対格 vesāliṃ)
* viharanti = 「住する」
* te sabbe = 「それらすべてを」(対格)
...
* evaṃ bhante = 「かしこまりました、尊者よ」
* āyasmā ānando = 「尊者アーナンダは」(男性主格)
* bhagavato paṭissutvā = 「世尊に応諾して」(paṭissuṇāti の連続体)
...
* bhagavantaṃ = 「世尊に」(対格)
* etad avoca = 「次のように言った」(etad〔これを〕+ avoca〔vatti のアオリスト〕)
* sannipatito = 「集まりました」(sannipatati〔集合する〕の過去分詞・男性主格。自動詞「集まった」)
...
* yassa = 「～のために（よしと）」(関係代名詞・属格。「～するのに（ふさわしい）」を導く)
* dāni = 「今や」(idāni の略形)
* bhante = 「尊者よ」(呼格)
* bhagavā = 「世尊が」(主格)
...
…pe… は（中略）と訳す。異読は本箇所には現れない。

1. Atha kho bhagavā yena upaṭṭhānasālā tenupasaṅkami; upasaṅkamitvā paññatte āsane nisīdi.

* atha kho = 「そこで」
* yena upaṭṭhānasālā tena upasaṅkami = 「侍者堂（集会堂）のあるところへ近づいた」(yena … tena …〔～のところへ〕の慣用構文。連声 tenupasaṅkami)
  * upaṭṭhānasālā = 「侍者堂・集会堂」(依主釈：upaṭṭhāna〔給仕・伺候〕+ sālā〔堂〕)
* upasaṅkamitvā = 「近づいて」(upasaṅkamati の連続体)
...
* ayaṃ pi kho = 「実にこの～もまた」(ayaṃ〔この〕+ pi〔も〕)
* ānāpānassatisamādhi = 「入出息念の三昧（定）」(依主釈：ānāpānassati〔入出息念〕+ samādhi〔三昧・定〕)
* bhāvito = 「修習された」(bhāveti の過去分詞・男性主格)
* bahulīkato = 「多く修された、習熟された」(bahulī-karoti〔しばしば行う〕の過去分詞)
* santo ca eva = 「寂静であり」(santa〔寂静な・静まった〕)
* paṇīto ca = 「すぐれて妙であり」(paṇīta〔勝妙な・優れた〕)
* asecanako ca = 「混じり気がなく（それだけで満ち足りた）ものであり」(asecanaka〔注ぎ加える必要のない＝それ自体で完全に味わい深い〕。註は ojavanta〔滋味に富む〕anāsittaka〔何も加えられていない〕と釈す)
* sukho ca vihāro = 「楽なる住である」(sukha〔楽〕+ vihāra〔住・住法〕)
* uppannuppanne … dhamme = 「生起するそのつどの諸法を（対象として）」(uppanna の重複形〔配分〕+ dhamma、対格複数)
* pāpake akusale = 「悪しき不善なる」(pāpaka〔悪しき〕+ akusala〔不善〕)
...
* seyyathāpi = 「たとえば、ちょうど～のように」(譬喩を導く)
* gimhānaṃ pacchime māse = 「夏（暑季）の最後の月に」(gimha〔夏・暑季〕属格複数 + pacchima〔最後の〕+ māsa〔月〕処格)
* ūhataṃ = 「巻き上げられた」(ud + √han、ūhanati の過去分詞・中性、rajojallaṃ と一致)
* rajojallaṃ = 「塵と垢（ほこりとよごれ）」(相違釈：raja〔塵〕+ jalla〔垢・よごれ〕)
...
* idha = 「ここに（この教えにおいて）」
* araññagato vā = 「森に行き」(依主釈：arañña〔林・閑処〕+ gata〔行った〕)
* rukkhamūlagato vā = 「樹下に行き」(rukkha〔樹〕+ mūla〔根もと〕+ gata)
* suññāgāragato vā = 「空閑処（人気のない場所）に行き」(suñña〔空・無人の〕+ agāra〔家・屋〕+ gata)
* nisīdati = 「坐す」
...
* so = 「彼は」
* sato eva = 「まさに念をたもって（気づきをもって）」(sato〔念ある・正念の。本テキストでは sati は常に ñāṇasampayuttā ゆえ「智を伴う」を含意〕+ eva〔まさに〕、連声 satova)
...
* paṭinissaggānupassī = 「捨遣を随観する者として」(依主釈：paṭinissagga〔捨遣・放捨〕+ anupassī〔随観する者〕)
